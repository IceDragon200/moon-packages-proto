class MapEditorModel < State::ModelBase
  ...
  field :camera_move_speed,      type: Moon::Vector3,         default: proc{ |t| t.model.new(8,8,0) }
  field :camera,                 type: Camera3
  field :cam_cursor,             type: CameraCursor,          default: proc{ |t| t.model.new }
